...
async def create_product(new_product: ProductCreate,
    ...
    return await services.create_product(session=session,
...
async def update_product(product_update: ProductUpdate,
    ...
    return await services.update_product(session=session,
                                          product=product,
...
async def delete_product(product: Product = Depends(get_product_by_id),
    ...
    return await services.delete_product(session=session,
                                     product=product)
